...
import 'package:gaanap_admin_new/views/radio/radio_playlist_screen.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutesName.finalScorecard:
        ...
        return MaterialPageRoute(
            builder: (context) => FinalScorecard(
                  gameid: args?["game_id"],
                ));

      case RoutesName.radioPlaylistScreen:
        return MaterialPageRoute(
            builder: (context) => const RadioPlaylistScreen());
